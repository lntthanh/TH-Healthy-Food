...
$ecolife_single_product_layout = 'sidebar';
if(isset($ecolife_opt['single_product_layout']) && $ecolife_opt['single_product_layout']!=''){
	$ecolife_single_product_layout = $ecolife_opt['single_product_layout'];
}
if(isset($_GET['layout']) && $_GET['layout']!=''){
	$ecolife_bloglayout = $_GET['layout'];
}
$singleproductsidebar = 'right';
if(isset($ecolife_opt['sidebarsingleproduct_pos']) && $ecolife_opt['sidebarsingleproduct_pos']!=''){
	$singleproductsidebar = $ecolife_opt['sidebarsingleproduct_pos'];
}
...
$ecolife_single_product_main_extra_class = NULl;
if($singleproductsidebar=='left') {
	$ecolife_single_product_main_extra_class = 'order-lg-last';
}
?>
<?php 
...
<div id="product-<?php the_ID(); ?>" <?php wc_product_class(); ?>>
		...
		<div class="row">
			<div class="page-content col-12 <?php if ( $ecolife_single_product_layout=='sidebar' && is_active_sidebar( 'sidebar-single_product' ) ) { echo ' col-lg-9 main-column'; } ?> product-content-wrapper <?php echo esc_attr($ecolife_single_product_main_extra_class);?>">
					...
					<div class="row">
						...
						<div class="single-product-info-wrapper col-12 col-lg-6 col-xl-7">
							<div class="summary entry-summary single-product-info">
								...
								?>
								<?php 
								if(function_exists('ecolife_product_sharing')) { ?>
									<div class="single-product-sharing">
										<?php ecolife_product_sharing(); ?>
									</div>
								<?php } ?>
							</div><!-- .summary -->
						</div>
			...
			<?php if ( $ecolife_single_product_layout=='sidebar' && is_active_sidebar( 'sidebar-single_product' ) ) : ?>
