...
if(count($jscomposer_templates) > 0) {
	foreach($jscomposer_templates as $jscomposer_template){
		if($jscomposer_template->post_title == 'Header2' || $jscomposer_template->post_title == 'Footer1'){
			 	...
			 	<div class="header">
					<div class="header-content">
						...
						if ( isset($ecolife_opt['header_layout']) && $ecolife_opt['header_layout']!="") {
							...
							if(count($jscomposer_templates) > 0) {
								foreach($jscomposer_templates as $jscomposer_template){
									if($jscomposer_template->post_title == 'Header2'){ ?>
							...
							if ( isset($ecolife_opt['sticky_header']) && $ecolife_opt['sticky_header']) {
								if(count($jscomposer_templates) > 0) {
									foreach($jscomposer_templates as $jscomposer_template){
										if($jscomposer_template->post_title == 'HeaderSticky2'){ ?>
