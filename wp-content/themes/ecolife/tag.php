	...
	<div class="container">
		<div class="row">
			<div class="col-12 <?php echo 'col-lg-'.$ecolife_blogcolclass; ?> <?php echo esc_attr($main_column_class); ?> <?php echo esc_attr($ecolife_blog_main_extra_class);?>">
				<div class="page-content blogs blog-page <?php echo esc_attr($ecolife_blogclass); if($ecolife_blogsidebar=='left') {echo ' left-sidebar'; } if($ecolife_blogsidebar=='right') {echo ' right-sidebar'; } ?>">
					...
					<?php if ( have_posts() ) : ?>
						<?php if ( tag_description() ) : // Show an optional tag description ?>
							<div class="archive-header">
								<h2 class="archive-title"><?php printf( wp_kses(__( 'Tag Archives: %s', 'ecolife' ), array('span'=>array())), '<span>' . single_tag_title( '', false ) . '</span>' ); ?></h2>
