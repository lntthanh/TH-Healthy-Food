...
class RoadthemeLayout {
	...
	<form action="" method="post"><?php
				...
				if ( $count ) :
					?><h2><?php esc_html_e( 'Your website needs a few essential plugins. The following plugins will be installed or updated', 'ecolife' ); ?></h2>
					...
					?><p class="lead success"><strong><?php esc_html_e( ' All plugins has already been installed and up to date.', 'ecolife' ) ?></strong></p><?php
				endif;
				?>
				<p class="roadtheme_plugins">
					<?php 	if ( $count ) : ?><a href="#" class="button-primary button button-large button-next install" ><?php esc_html_e( 'Install plugins', 'ecolife' ); ?></a><?php endif; ?>
					<a href="#install_demo" class="button-primary button button-large button-next demo_data" ><?php esc_html_e( 'Install Demo Data', 'ecolife' ); ?></a>
				</p>
			</form>
	...
	static function load_system_requiment() {
		...
		<ul class="system_requirement">
			<li>
				<span><b><?php esc_html_e('PHP Version: ', 'ecolife'); echo PHP_VERSION; ?></b></span>
				<span class="system_icon<?php echo esc_attr(self::check_field_status(PHP_VERSION, '5.6')); ?>"></span>		</br>
				<span><a href="https://wordpress.org/support/article/requirements/"><?php esc_html_e('Requiment ', 'ecolife'); ?></a></span>	
			</li>
			<li>
				<b><?php esc_html_e('Memory Limit: ', 'ecolife'); echo ini_get('memory_limit') ;  ?></b>
				<span><?php esc_html_e('Memory Limit requires at least 256M of memory ', 'ecolife');   ?></span>
			...
			<li>
				<b><?php esc_html_e('Max Execution Time: ', 'ecolife'); echo $max_execution_time ;  ?></b>
				<span><?php esc_html_e('Max Execution Time requires at least 300s of PHP execution time: ', 'ecolife'); ?></span>
				<span class="system_icon<?php echo esc_attr(self::check_field_status($max_execution_time, 300)); ?>"></span>				
			</li>
			<li>
				<b><?php esc_html_e('Max Upload File Size: ', 'ecolife'); echo $file_size ;  ?></b>
				<span><?php esc_html_e('Max Upload File Size requires at least 2M of total upload file size: ', 'ecolife'); ?></span>
				<span class="system_icon<?php echo esc_attr(self::check_field_status($file_size, 2*MB_IN_BYTES)); ?>"></span>				
			</li>
			<li>
				<b><?php esc_html_e('Server Max Post Size: ', 'ecolife'); echo $post_max_size_limit ;  ?></b>
				<span><?php esc_html_e('Server Max Post Size requires at least 8M of total file size: ', 'ecolife'); ?></span>
...
RoadthemeLayout::load_demo_data();
	...
	esc_html_e('You need fix all error in required Sytem to can continue setup ', 'ecolife');
}
?>
<script type="text/javascript">
