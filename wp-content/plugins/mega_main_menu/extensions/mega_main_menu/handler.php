...
*/
			...
			$items_wrap .= mm_common::ntab(1) . '<div class="mmm_fullwidth_container"></div><!-- /.fullwidth_container -->';
			...
			if( $mega_main_menu->get_option( $theme_location_safe_name . '_logo_src' ) ) {
				...
				$items_wrap .= mm_common::ntab(4) . '<a class="logo_link" href="' . esc_attr( $logo_link ) . '" title="' . esc_attr( get_bloginfo( 'name' ) ) . '">';
			...
			$items_wrap .= mm_common::ntab(5) . '</span><!-- /.mobile_button -->';
			$items_wrap .= mm_common::ntab(4) . '</span><!-- /.mobile_toggle -->';
			$items_wrap .= mm_common::ntab(3) . '</span><!-- /.nav_logo -->';
			$items_wrap .= mm_common::ntab(4) . $args['items_wrap'];
			$items_wrap .= mm_common::ntab(2) . '</div><!-- /.menu_inner -->';
			$items_wrap .= mm_common::ntab(1) . '</div><!-- /.menu_holder -->';
			$items_wrap .= mm_common::ntab(0) . '</div><!-- /.mega_main_menu -->';
