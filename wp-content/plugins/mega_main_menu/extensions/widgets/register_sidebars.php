 ...
 */
	...
	if ( !function_exists( 'mmm_register_mega_main_menu_shortcode' ) ) {
		...
		function mmm_mega_main_menu_shortcode ( $atts = null, $content = null ) {
			...
			extract( $atts );
			// 1608921033. The verification of the "$structure" variable with help of "wp_get_nav_menus" was removed because it messes up the following (future) menu structures. Also, this verification was unnecessary, just an extra safety feature.
/*
